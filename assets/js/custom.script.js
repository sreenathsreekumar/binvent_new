    ...
    $(document).ready(function () {
        ...
        if ($('#lgx-owltestimonial').length) {
            $("#lgx-owltestimonial").owlCarousel({
                ...
                autoplay: true,
                dots: true,
                navText: ["<img src='./assets/img/icons/left-arrow.png'>", "<img src='./assets/img/icons/right-arrow.png'>"],
                autoplayTimeout: 5000,
                autoplaySpeed: 500,
                nav: true,
                addClassActive: true,
        ...
        $contactForm.validate({
            submitHandler: function (form) {
                ...
                $('.lgx-form-msg').addClass('alert-success').text('Email notification has been send to the Admin. We will get back to you soon..');
